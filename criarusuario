							...
							then
								...
								then
									...
									then
										...
										read -p "N° de conexões simultâneas permitidas: " sshlimiter
										...
										then
											...
											then
												...
												then
													...
													[ $? -eq 0 ] && tput setaf 2 ; tput bold ; echo ""; echo "Usuário $username criado" ; echo "Data de expiração: $gui" ; echo "N° de conexões simultâneas permitidas: $sshlimiter" ; echo "" || echo "Não foi possível criar o usuário!" ; tput sgr0
