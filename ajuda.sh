#!/bin/bash
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-10s\n' "Comandos disponíveis no OpenVPN (RNEOX PREMIUM):" ; tput sgr0 ; echo ""
tput setaf 2 ; tput bold ; printf '%s' "alterarsenha " ; tput setaf 7 ; printf '%s' "- " ; tput setaf 3 ; echo "Alterar a senha de um usuário" ; echo "" ;
tput setaf 2 ; tput bold ; printf '%s' "criarusuario " ; tput setaf 7 ; printf '%s' "- " ; tput setaf 3 ; echo "Criar usuário sem acesso ao terminal e com data de expiração" ; echo ""
...
tput setaf 2 ; tput bold ; printf '%s' "remover " ; tput setaf 7 ; printf '%s' "- " ; tput setaf 3 ; echo "Remover um usuário" ; echo ""
tput setaf 2 ; tput bold ; printf '%s' "statusvpn " ; tput setaf 7 ; printf '%s' "- " ; tput setaf 3 ; echo "Mostrar usuários ativos no OpenVPN" ; echo ""
tput setaf 2 ; tput bold ; printf '%s' "speedtest-cli " ; tput setaf 7 ; printf '%s' "- " ; tput setaf 3 ; echo "SpeedTest para medir a potência do link do seu servidor" ; echo ""
